...
describe('Spec Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'spec', component: SpecComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.specs?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
